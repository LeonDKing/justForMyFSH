function myUpload(a,c){
    var b = a.target.result;
    //var data = {
    //    "fileHeader": b.substring(b.indexOf(":")+1,b.indexOf(";")),
    //    "fileData": b.substring(b.indexOf(",")+1).toString()
    //}
    c.resolve(b);
    //
    //$.ajax({
...
*/
        ...
        var b = function (b) {
            ...
            return a.Deferred(function (c) {
                a("<img class='onlyUploadUse'>").one("load", function () {
                    c.resolve(a(this))
